...
public class Toolbar extends Component {
	...
	protected void createChildren() {
		...
		add( btnQuick[3] = new QuickslotTool(64, 0, 32, 36, 3) );
		add( btnQuick[2] = new QuickslotTool(64, 0, 32, 36, 2) );
		add( btnQuick[1] = new QuickslotTool(64, 0, 32, 36, 1) );
		add( btnQuick[0] = new QuickslotTool(64, 0, 32, 36, 0) );
